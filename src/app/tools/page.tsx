...
const CATEGORY_ICON_BG: Record<string, string> = {
  ...
  attention:     "bg-sky-50",
  planning:      "bg-indigo-50",
  impulsivity:   "bg-cyan-50",
  sensory:       "bg-emerald-50",
  selfcare:      "bg-rose-50",
  eating:        "bg-orange-50",
  perfectionism: "bg-purple-50",
  people:        "bg-yellow-50",
  burnout:       "bg-teal-50",
  interoception: "bg-violet-50",
  emotion:       "bg-pink-50",
};
...
const CATEGORY_BORDER_ACCENT: Record<string, string> = {
  ...
  attention:     "border-l-sky-200",
  planning:      "border-l-indigo-200",
  impulsivity:   "border-l-cyan-200",
  sensory:       "border-l-emerald-200",
  selfcare:      "border-l-rose-200",
  eating:        "border-l-orange-200",
  perfectionism: "border-l-purple-200",
  people:        "border-l-yellow-200",
  burnout:       "border-l-teal-200",
  interoception: "border-l-violet-200",
  emotion:       "border-l-pink-200",
};
